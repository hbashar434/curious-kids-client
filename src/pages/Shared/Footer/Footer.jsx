    ...
    <div>
      <footer className="footer p-10">
        <div>
          ...
          <div>
            <p className="mt-1 text-lg font-bold text-gray-600">Follow Us</p>
            <div className="mt-1 md:place-self-center md:justify-self-start  cursor-pointer">
        ...
        <div>
          ...
          <a className="link link-hover">123 ABC Street, XYZ City</a>
          <a className="link link-hover">Phone: (123) 456-7890</a>
          <a className="link link-hover">Email: info@curiouskids.com</a>
        </div>
      </footer>
      <div className="footer px-10 py-4 md:px-24 border-t bg-pink-50 border-base-300">
        ...
        <div className="md:place-self-center md:justify-self-end">
          <p>
            Powered By Curious Kids <br />@{new Date().getFullYear()} Curious
